        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">House #12, Road #05, Dhanmondi, Dhaka-1205, Bangladesh</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@psynergybd.com</p>
                    <p className="text-gray-600">support@psynergybd.com</p>
                  </div>
                </div>
            ...
            <div className="w-full h-64 rounded-3xl overflow-hidden shadow-inner border border-gray-100">
              <iframe 
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3652.2277363400516!2d90.3725514758965!3d23.739256989212!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755bf36353d2679%3A0x6b4461329c4252e!2sDhanmondi%2C%20Dhaka!5e0!3m2!1sen!2sbd!4v1700000000000!5m2!1sen!2sbd" 
                width="100%" 
                height="100%" 
                style={{ border: 0 }} 
